...
public class DialogController {
    ...
    public static Dialog showInputTextDialog(final Activity activity, final String text, final View.OnClickListener enterClick, final View.OnClickListener cancelClick) {
