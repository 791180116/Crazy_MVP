...
import com.crazy.base.action.BundleAction;
import com.crazy.base.action.ClickAction;
 ...
 * desc   : Fragment 基类
 */
public abstract class BaseFragment<A extends BaseActivity> extends XFragment implements
    ...
    public void onResume() {
        ...
        if (!mLoading) {
            mLoading = true;
            initData(getSavedInstanceState());
